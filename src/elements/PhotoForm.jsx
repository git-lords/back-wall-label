...
const PhotoForm = () => {
  ...
  return (
    <div className="bg-white dark:bg-zinc-700 border p-2 overflow-auto w-1/2">
      <details title="Add a Band Photo">
        ...
        <div className="flex flex-col h-full justify-evenly">
          ...
          <form action="" onSubmit={onSubmit} className="flex flex-col">
            ...
            />
            <button className="p-4 border my-2 bg-emerald-600 hover:bg-emerald-700 duration-200 text-white">
              Add Photo
            </button>
          </form>
          {added && (
          ...
          <div className="flex flex-col h-full items-center m-6">
            ...
            {isDeleting && (
              <div className="bg-zinc-600 p-4 flex flex-col items-center">
                <h1>Are you sure?</h1>
                <button
